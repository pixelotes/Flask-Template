...
def configure_logging(app):
    ...
    # Rota cada 10MB, mantiene 5 backups. Nombre: logs.json
...
from src.routes import auth_bp, main_bp, admin_bp

app.register_blueprint(auth_bp)
app.register_blueprint(main_bp)
app.register_blueprint(admin_bp)

from src.cli import import_users_command, init_admin_command
